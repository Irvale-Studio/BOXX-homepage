      ...
      >
        ...
        >
          ...
          <button
            ...
            className="w-full sm:w-[260px] px-8 py-6 border border-white/20 text-sm tracking-[0.2em] uppercase hover:bg-white/10 hover:border-white/40 transition-all duration-500 text-center whitespace-nowrap"
          >
            Explore Classes
          </button>
        </motion.div>
