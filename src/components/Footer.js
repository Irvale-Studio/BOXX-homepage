...
const footerLinks = [
  ...
  },
  {
    title: 'Members',
    links: [
      { name: 'Book a Class', href: `${PLATFORM_URL}/book`, external: true },
      { name: 'Buy Class Packs', href: `${PLATFORM_URL}/buy-classes`, external: true },
      { name: 'Member Login', href: `${PLATFORM_URL}/login`, external: true },
      { name: 'My Dashboard', href: `${PLATFORM_URL}/dashboard`, external: true },
    ],
  },
  {
    title: 'Classes',
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-10">
          ...
          <div className="md:col-span-5 lg:col-span-5">
            ...
            <div className="flex items-center gap-3 mt-6">
              ...
              <a href={`https://wa.me/${phone.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center border border-white/[0.08] text-white/30 hover:text-accent hover:border-accent/30 transition-all duration-300" aria-label="WhatsApp">
        ...
        <div className="mt-20 pt-10 border-t border-white/[0.04]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-12">
            ...
            <div>
              ...
              <a href={`mailto:${email}`} className="text-sm text-white/30 hover:text-accent transition-colors">
                {email}
              </a>
            </div>
            <div>
              <p className="text-[10px] tracking-[0.3em] uppercase text-white/20 mb-2">Phone</p>
              <a href={`tel:${phone.replace(/[^0-9+]/g, '')}`} className="text-sm text-white/30 hover:text-accent transition-colors">
                {phone}
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-white/[0.03]">
            ...
            <div className="flex items-center gap-4">
              <Link href="/privacy" className="text-[11px] text-white/15 hover:text-accent transition-colors duration-300 tracking-wider">
                Privacy Policy
              </Link>
